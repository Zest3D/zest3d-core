...
package zest3d.localeffects 
{
	 ...
	 */
	public class RenderTargetEffect extends VisualEffectInstance 
	{
		...
		public function RenderTargetEffect( texture:TextureRectangle, filter:SamplerFilterType = null,
										  coord0: SamplerCoordinateType = null, coord1: SamplerCoordinateType = null ) 
		{
			...
			var vShader: VertexShader = new VertexShader( "Zest3D.RenderTargetEffect", 2, 1, 1, 0, false );
			...
			var pShader: FragmentShader = new FragmentShader( "Zest3D.RenderTargetEffect", 1, 1, 0, 1, false );
